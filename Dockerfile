...
COPY entrypoint-organisasi.sh /home/runner/actions-runner/entrypoint-organisasi.sh

# Make the entrypoint script executable
RUN chmod +x /home/runner/actions-runner/entrypoint-organisasi.sh
...
ENTRYPOINT ["/home/runner/actions-runner/entrypoint-organisasi.sh"]
